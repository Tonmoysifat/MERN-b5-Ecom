                    ...
                    <div className="row">
                        ...
                        <div className="col-md-5 p-3">
                            ...
                            <div className="row">
                                ...
                                <div className="col-4 p-2">
                                    <SubmitButton onClick={async ()=>{await AddCart(ProductDetails[0]["_id"])}} className="btn w-100 btn-success" text="Add to Cart"/>
                                </div>
                                <div className="col-4 p-2">
                                    {/*<button onClick={async ()=>{await AddWish(ProductDetails[0]["_id"])}} className="btn w-100 btn-success">Add to Wish</button>*/}
                                    <SubmitButton onClick={async ()=>{await AddWish(ProductDetails[0]["_id"])}} className="btn w-100 btn-success" text="Add to Wish"/>
